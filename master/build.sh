...
make_setup_mkinitcpio() {
    ...
    cp archiso_plymouth.initcpio_hook ${work_dir}/${arch}/airootfs/etc/initcpio/hooks/archiso_plymouth
    cp archiso_plymouth.initcpio_install ${work_dir}/${arch}/airootfs/etc/initcpio/install/archiso_plymouth
